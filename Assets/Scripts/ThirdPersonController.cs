...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            TotalStamina = FindFirstObjectByType<LevelManager>().stamina;
            _hasAnimator = TryGetComponent(out _animator);
        ...
        private void Move()
        {
            ...
            float targetSpeed = (_input.sprint && TotalStamina > 0) ? SprintSpeed : MoveSpeed;
            ...
            {
                FindFirstObjectByType<LevelManager>().IncreaseStamina(0.05f);
            }
